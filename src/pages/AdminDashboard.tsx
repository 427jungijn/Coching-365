          ...
          <div className="space-y-6">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4 flex items-center">
                ...
                구글 시트 자동 기록 설정 (Apps Script)
              </h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700">Google Apps Script 웹 앱 URL</label>
                  <p className="text-xs text-gray-500 mb-2">구글 시트의 Apps Script에서 발급받은 URL을 입력하세요. 회원이 스트레칭을 완료하면 시트에 자동으로 기록됩니다.</p>
                  <input 
                    type="url" 
                    value={webhookUrl} 
